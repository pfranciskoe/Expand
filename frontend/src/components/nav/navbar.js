...
class NavBar extends React.Component {
  ...
  toggleDropdown(e) {
    ...
    if (
      (e.target === dropdownButton || e.target === dropdownArrow) &&
      !dropdownMenu.classList.contains('show-list')
    ) {
      ...
      return (
        <div className="burger-menu">
          <div className="user-courses">
            <NavLink className="my-courses" to={'/courses'}>
              Courses
            </NavLink>
            <button
              id="dropdown-button"
              className="button courses-arrow dropdown"
            >
