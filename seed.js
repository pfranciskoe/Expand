    ...
    const courses_arr = [
      {
        ...
        description:
          'A deep dive into the agricultural nuances of raising spuds.',
        lessons: [],
      },
      {
        instructor: `${user1}`,
      ...
      },
      {
        ...
        description:
          'A complete course on the fundamentals of React and Redux.',
        lessons: [],
      },
    ];
        ...
        const lessons_arr = [
          {
            ...
            description:
              'Something about roots, if potatoes even have roots idk find out with this video.',
            videoUrl:
              'https://expand-dev.s3-us-west-1.amazonaws.com/rick-1589412873465.mp4',
            instructor: user1,
            course: course0,
            order: 1,
          ...
          },
          {
            ...
            description:
              "Potatoes are our friends. Treat them with dignity and respect, and they'll end up tastier.",
            videoUrl:
              'https://expand-dev.s3-us-west-1.amazonaws.com/rick-1589412873465.mp4',
            instructor: user1,
            course: course0,
          ...
          },
          {
            ...
            description:
              'Welcome to our introduction to the Go programming language. This lesson will provide an introduction to Go.',
            videoUrl:
              'https://expand-dev.s3-us-west-1.amazonaws.com/golang1.mp4',
            instructor: user1,
            course: course1,
            order: 1,
          ...
          },
          {
            ...
            description:
              'This lesson will provide a structured approach describing an introductory development environment to get you programming in Go.',
            videoUrl:
              'https://expand-dev.s3-us-west-1.amazonaws.com/Golang2.mp4',
            instructor: user1,
            course: course1,
            order: 2,
            thumbnailUrl: '/images/boxvid1',
          ...
          },
          {
            title: 'Variables',
            description:
              'This lesson will go in-depth describing the nuances of Go variables.',
            videoUrl:
              'https://expand-dev.s3-us-west-1.amazonaws.com/golang3.mp4',
            instructor: user1,
            course: course1,
            order: 3,
            thumbnailUrl: '/images/boxvid1',
          ...
          },
          {
            ...
            videoUrl:
              'https://expand-dev.s3-us-west-1.amazonaws.com/Computer+Keyboard+-+3174.mp4',
            instructor: user1,
            course: course2,
            order: 1,
          ...
          },
          {
            ...
            description:
              'This individual is much more productive now that they have a nice shot of espresso.',
            videoUrl:
              'https://expand-dev.s3-us-west-1.amazonaws.com/Keyboard+-+1046.mp4',
            instructor: user1,
            course: course2,
            order: 2,
            thumbnailUrl: '/images/dada1',
          ...
          },
          {
            ...
            description:
              'To be honest we are not completely sure if any typing is going on. Cool fan though.',
            videoUrl:
              'https://expand-dev.s3-us-west-1.amazonaws.com/Homework+-+1028.mp4',
            instructor: user1,
            course: course2,
            order: 3,
            thumbnailUrl: '/images/dada1',
          ...
          },
          {
            ...
            videoUrl:
              'https://expand-dev.s3-us-west-1.amazonaws.com/y2mate.com+-+HTML+Tutorial+for+Beginners+-+00+-+Introduction+to+HTML_dD2EISBDjWM_240p.mp4',
            instructor: user4,
            course: course3,
            order: 1,
          ...
          },
          {
            ...
            description:
              'https://expand-dev.s3-us-west-1.amazonaws.com/y2mate.com+-+HTML+Tutorial+for+Beginners+-+01+-+Creating+the+first+web+page_-USAeFpVf_A_144p.mp4',
          ...
          },
          {
            ...
            description:
              'https://expand-dev.s3-us-west-1.amazonaws.com/y2mate.com+-+HTML+Tutorial+for+Beginners+-+02+-+Line+breaks%2C+spacing%2C+and+comments_i3GE-toQg-o_240p.mp4',
            videoUrl: '/videos/womp1',
            instructor: user4,
            course: course3,
            order: 3,
          ...
          },
          {
            ...
            videoUrl:
              'https://expand-dev.s3-us-west-1.amazonaws.com/y2mate.com+-+Complete+React+Tutorial+(%26+Redux+)+%231-+Introduction_OxIDLw0M-m0_240p.mp4',
            instructor: user4,
            course: course4,
            order: 1,
          ...
          },
          {
            ...
            description:
              "in this React tutorial I'll be giving you a very birds-eye view of how React works behind the scenes.",
            videoUrl:
              'https://expand-dev.s3-us-west-1.amazonaws.com/y2mate.com+-+Complete+React+Tutorial+(%26+Redux)++%232+-+How+React+Works_pKYiKbf7sP0_360p.mp4',
            instructor: user4,
            course: course4,
            order: 2,
            thumbnailUrl: '/images/coff1',
          ...
          },
          {
            ...
            description:
              "We will only use the React CDN for the first few lessons, to learn the basics. Then we'll move on to create full React apps with the Create React App package.",
            videoUrl:
              'https://expand-dev.s3-us-west-1.amazonaws.com/y2mate.com+-+Complete+React+Tutorial+(%26+Redux)+%233+-+React+Setup+(with+CDN)_SAX6RMEFVM4_360p.mp4',
            instructor: user4,
            course: course4,
            order: 3,
            thumbnailUrl: '/images/coff1',
            ...
            const comments_arr = [
              {
                author: user2,
                text:
                  "In this part you're talking about eyes, but I'm not sure potatoes are alive??",
                lesson: lesson0,
                timestamp: 64,
              },
              {
              ...
              },
              {
                author: user3,
                text:
                  "Those potatoes have SO MUCH dirt on them. I wouldn't eat them if I were you.",
                lesson: lesson0,
                timestamp: 5,
              },
              {
                author: user5,
                text:
                  'That looks like Boise! I moved there with Mrs. Potato Head back in the day during the great potato famine.',
                lesson: lesson0,
                timestamp: 55,
              },
            ];
                ...
                const responses_arr = [
                  {
                    author: user1,
                    text:
                      'These are the potatoes of Omicron Persei 8, which are both alive and sentient.',
                    parent: comment0,
                  },
                  {
                    author: user2,
                    text:
                      'Remember when Dan Quayle insisted that potato was spelled with an E?',
                    parent: comment0,
                  },
                  {
                    author: user5,
                  ...
                  },
                  {
                    author: user1,
                    text:
                      'See this video for thorough instruction on doing the twist.',
                    parent: comment1,
                  ...
                  },
                  {
                    author: user3,
                    text:
                      'I think their eyes are more like the eye of a needle, or the eye of a storm. Totally fictional.',
                    parent: comment0,
                  },
                  {
                    author: user5,
